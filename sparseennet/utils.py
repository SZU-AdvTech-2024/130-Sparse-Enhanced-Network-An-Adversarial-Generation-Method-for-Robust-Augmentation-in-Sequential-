...
def generate_rating_matrix_valid(user_seq, num_users, num_items):
    ...
    col = np.array(col)
    data = np.array(data)
    rating_matrix = csr_matrix((data, (row, col)), shape=(num_users, num_items + 1))  # sparse matrix
...
def generate_rating_matrix_test(user_seq, num_users, num_items):
    ...
    col = np.array(col)
    data = np.array(data)
    rating_matrix = csr_matrix((data, (row, col)), shape=(num_users, num_items + 1))
